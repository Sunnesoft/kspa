...
func (st *DfsStacked) TopKShortestPaths(g *MultiGraph, srcId int, topK int) (res PriorityQueue) {
...
func (st *DfsStacked) TopKShortestPathsMultiSources(g *MultiGraph, srcIds []int, targetIds []int, topK int) (res []PriorityQueue) {
	var pq []PriorityQueue
